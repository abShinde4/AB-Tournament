    ...
    <main className="page">
      <section className="card">
        ...
        <ul>
          ...
          <li>Payment and wallet transaction details</li>
        ...
        <ul>
          ...
          <li>To communicate tournament updates and results</li>
        ...
        <h2>10. Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, please contact us at [Contact Email- shindearman1910@gmail.com].</p>
      </section>
    </main>
  );
};
